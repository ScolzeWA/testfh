...
async def play(_, message: Message):
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                try:
                    ...
                    await fallen.edit(
                        "<b>» ارفعني ادمن مع حميع الصلاحيات</b>")
                    return

                try:
                    await USER.join_chat(invitelink)
                    await USER.send_message(
                        message.chat.id, "» تم انضمام الحساب المساعد بنجاح تستطيع الان تشغيل الاغاني في المحادثات الصوتيه")

                except UserAlreadyParticipant:
                    pass
                except Exception:
                    await fallen.edit(
                        f"<b>» الحساب المساعد لا يوجد في هذه المحادثه ارسل /join مره لانضمام الحساب المساعد الي هذه المحادثه")
    try:
    ...
    if audio:
        ...
        if len(message.command) < 2:
            return await fallen.edit(
                "» اكتب شي للبحث او اعطيني اسم الاغنيه صالح 🤦🏻‍♂️"
            )
        await fallen.edit("🔎")
        ...
        try:
            ...
            await fallen.edit(
                "» اكتب اسم الاغنيه مره اخري بطريقه صحبحه 🙂"
            )
            print(str(e))
            return
    ...
    if int(chat_id) in ACTV_CALLS:
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("• قناه البوت •", url=f"https://t.me/Ch_World_Music"),
